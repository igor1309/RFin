...
struct ScenarioModityQuickPL: View {
    ...
    var body: some View {
        Section(header: Text("Modify Quick P&L".uppercased()),
                footer: Text("Use steppers above to modify Quick P&L.")) {
                    ...
                    Group {
                        Stepper(value: $scenario.investment, in: 300_000...50_000_000, step: 50_000) {
                            ...
                            .contextMenu {
                                Button(action: {
                                    self.scenario.investment = 400_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(400_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.investment = 500_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(500_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.investment = 600_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(600_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.investment = 650_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(650_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.investment = 30_000_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                        ...
                        Stepper(value: $scenario.noOfCoversPerWeek, in: 400...1500, step: 10) {
                            ...
                            .contextMenu {
                                Button(action: {
                                    self.scenario.noOfCoversPerWeek = 480
                                }) {
                                    HStack {
                                ...
                                Button(action: {
                                    self.scenario.noOfCoversPerWeek = 600
                                }) {
                                    HStack {
                                ...
                                Button(action: {
                                    self.scenario.noOfCoversPerWeek = 720
                                }) {
                                    HStack {
                        ...
                        Stepper(value: $scenario.payrollRate, in: 30_000...80_000, step: 5_000) {
                            ...
                            .contextMenu {
                                Button(action: {
                                    self.scenario.payrollRate = 40_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(40_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.payrollRate = 50_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(50_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.payrollRate = 55_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(55_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.payrollRate = 60_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
                                    Text(60_000.formattedGrouped)
                                }
                                Button(action: {
                                    self.scenario.payrollRate = 80_000
                                }) {
                                    Image(systemName: "arrow.uturn.left.square")
